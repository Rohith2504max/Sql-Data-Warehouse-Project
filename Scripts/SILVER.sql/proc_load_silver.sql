	...
	BEGIN TRY
		...
		SELECT
			...
			CASE WHEN sls_price IS NULL OR sls_price <= 0 
				 THEN CAST(sls_sales AS DECIMAL(18,2)) / NULLIF(CAST(sls_quantity AS DECIMAL(18,2)), 0)
		...
		SET @start_time = GETDATE();
		PRINT '>>> Truncating Table silver.erp__cust_az12';
		TRUNCATE TABLE silver.erp__cust_az12;
		PRINT'>>> INSERTING INTO : silver.erp__cust_az12';
		INSERT INTO silver.erp__cust_az12(
				cid,
				bdate,
				gen
		)
